  ...
  return (
    <div className="relative">
      <div className="relative h-screen overflow-y-auto">
        ...
        {/* Account Detail */}
        <div className="w-full mt-3 text-xs font-medium">
          <div className="flex flex-row p-3 my-2 border-t border-b border-[#0C2036] border-opacity-50">
